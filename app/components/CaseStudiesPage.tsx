...
const CASES: CaseStudy[] = [
  {
    ...
    details:
      "Complex, unclear access & authorization process causing heavy support load. Applied personas, journey mapping, IDIs, Design Studio, prototype testing. Created contextual workflows + natural language questions replacing legalese. Result: improved adoption, reduced support costs, higher task success rates.",
  },
  {
    title: 'BANQUP',
    ...
    details:
      'BanqUP needed personalization at scale for different small businesses. Designed onboarding flows with simple questions to unlock personalized features. Created tagging tools, smart analytics, and integrated dashboards. Result: tailored experience combining simplicity with flexibility.',
  },
  {
    title: 'BANK BPH',
  ...
  },
  {
    ...
    details:
      "Orchestrated end-to-end service design initiative for Poland's largest insurer. Started with discovery interviews, workshops, and journey mapping to uncover critical barriers. Used progressive disclosure, smart defaults, and wireframed prototypes to streamline car insurance quote funnel. Result: customer-centric InsurTech experience with improved usability scores.",
  },
  {
    title: 'PKO bank',
    ...
    <section className="py-16 px-6 bg-white">
      <div className="max-w-7xl mx-auto" style={{ ['--campaign-accent' as any]: '#7c3aed' }}>
        ...
        <CaseGrid
          ...
          colsClass="grid-cols-1 md:grid-cols-2 xl:grid-cols-2"
        />
      </div>
      <OutcomeBanner text="MEASURABLE IMPACT: IMPROVED ADOPTION • REDUCED COSTS • HIGHER SUCCESS RATES" fullBleed />
    </section>
  )
}