-- Extend allowed industry values to include 'DigitalTech'
...
alter table public.brand_industries add constraint brand_industries_industry_check
  check (industry in ('SaaS','Pharma','FinTech','Commerce','Manufacturing','Public','eLearning','Telecom','Retail','DigitalTech','Generic','Dummy'));
