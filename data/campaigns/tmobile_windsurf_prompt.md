# Windsurf IDE Prompt — Portfolio for T-Mobile Go2Market, UX & UI Lead

This is a **full specification** for Windsurf IDE to generate a professional portfolio microsite at **https://tmobile.hretheum.com**.  
The goal: Present **Eryk Orłowski** as the ideal candidate for **Go2Market, UX & UI Lead — One Portal Tribe at T-Mobile**.

---

## 🎯 Core Directives for Windsurf
- Render the site as a **single-page editorial microsite**.  
- Visual style: **Magenta-driven telecom energy**, bold typography, editorial layouts.  
- Tone of voice: Confident, visionary, with clear track record of **telecom and fintech impact**.  
...
- 20+ years in UX, design systems, and telecom/finance digital transformations.  
- Philosophy: *What I do today, the industry does in 5 years.*  
- Proven track record of **conversion uplift in telecom**, **design systems at ING**, **AI-powered design pipelines** at Sportradar.  
...
- **Orange** — Redesigned multiple **conversion flows across telecom products**, ensuring consistency and **usability at scale**.
...
## ✅ Output Expectations for Windsurf IDE
- Generate clean, production-ready React/Next.js code.  
- All text content comes **verbatim from sections above** — no placeholders.  
- Components: `<Hero>`, `<CaseStudies>`, `<PlaybookDiagram>`, `<MetricsGrid>`, `<QuoteBlock>`, `<CTA>`.  
- Optimized for desktop & mobile.  
- Deployed to subdomain: **tmobile.hretheum.com**.  
